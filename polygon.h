...
public:
    ...
    glm::vec3 barycentric(Polygon& poly, Triangle& tri, glm::vec3 point);

    //This function sets the bounding boxes for a given triangle
    void setBoundingBoxes(Triangle& tri);
